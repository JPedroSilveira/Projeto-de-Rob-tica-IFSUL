...
void leitura_linear(int tempo) {
  ...
  if(IR_read[0] == 1 && IR_read[1] == 1 && IR_read[2] == 1 && IR_read[3] == 0 && IR_read[4] == 0 && IR_read[5] == 0 && IR_read[6] == 0 && IR_read[7] == 0){
  ...
  /*else if (leitura_de_linha_direita == 1 && leitura_de_linha_esquerda == 0) {

      ir_direita(tempo);
      RGB_color("green");
      
    } else if(leitura_de_linha_direita == 1 && leitura_de_linha_esquerda == 1){
