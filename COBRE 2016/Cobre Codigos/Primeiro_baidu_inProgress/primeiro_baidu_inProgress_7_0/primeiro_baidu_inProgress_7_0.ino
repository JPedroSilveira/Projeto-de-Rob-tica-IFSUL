...
void leitura_linear(int tempo) {
  ...
  desviador("direita", tempo, 1500);
    
  }else if(IR_read[0] == 1 && IR_read[1] == 1 && IR_read[2] == 1 && IR_read[3] == 0 && IR_read[4] == 0 && IR_read[5] == 0 && IR_read[6] == 0 && IR_read[7] == 0){
    
  Pro_90("direita", tempo);
  
  }else if(IR_read[0] == 0 && IR_read[1] == 0 && IR_read[2] == 0 && IR_read[3] == 0 && IR_read[4] == 1 && IR_read[5] == 1 && IR_read[6] == 1 && IR_read[7] == 1){
...
void desviador(String direcao, int tempo , int tempo2){
...
void ultrasonico_frente(boolean mostrar){
  ...
  long leitura_echo = pulseIn(EchoPin_frente, HIGH,100000);
  if(leitura_echo == 0){
...
void ultrasonico_atras(boolean mostrar){
  ...
  long leitura_echo = pulseIn(EchoPin_atras, HIGH, 100000);
  if(leitura_echo == 0){
  distancia_atras = 450;
  }else{
