...
Versão avançada EEPROM seguidor_linear_digital calibrador_direcional (com música) semi-FUNCIONAL 
...
int leitor_de_linha_direita = 13;
int leitor_de_linha_esquerda = 12;
