...
void leitura_linear(int tempo) {
  ...
  if(distancia_frente <= 5 && conter <5){
...
if(direcao.equalsIgnoreCase("direita")){
     ...
     ir_direita(tempo2+1000);
     ir_frente(tempo_frente+1000);
     ir_esquerda(tempo2+2500);
     ir_frente(tempo_frente+tempo_frente-1000);
     ir_esquerda(tempo2+500);
     ir_frente(tempo_frente);
   //  robot_speed(95, 180); 
     
}else{
  
     ir_esquerda(tempo2+1000);
     ir_frente(tempo_frente+1000);
     ir_direita(tempo2+2500);
     ir_frente(tempo_frente+tempo_frente-1000);
     ir_esquerda(tempo2+500);
     ir_frente(tempo_frente);
     //robot_speed(180, 95);   
