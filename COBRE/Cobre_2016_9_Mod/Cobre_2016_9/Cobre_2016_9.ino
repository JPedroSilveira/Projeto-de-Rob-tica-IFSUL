...
const int TrigPin_esquerda = 0; //Frente agora!!!
const int EchoPin_esquerda = 0; //Frente agora!!!

long leitura_echo;

int distancia_direita = 0;
int distancia_esquerda = 0; //Frente agora!!!
...
void labirinto(){ 
  ultrasonico_esquerda(); // FRENTE
  ultrasonico_direita();
  if(distancia_esquerda<=5&&distancia_direita<=8){ //Caso 1 e 1 
    do{
      ir_esquerda();
      ultrasonico_esquerda();
      ultrasonico_direita();
    }while(distancia_esquerda<25||distancia_direita>8); //Só para quando a distancia frente for maior que 25 e a distancia direita menor que 8
  }else{
    if(distancia_esquerda<=5&&distancia_direita>8){ //Caso 1 e 0
      do{
        ir_esquerda();
        ultrasonico_esquerda();
        ultrasonico_direita();  
      }while(distancia_esquerda<25||distancia_direita<25);
    }else{
    ir_frente();
  }
...
void linha_paralela(){
      Qti_esquerda = analogRead(pin_Qti_esquerda);
      Qti_direita = analogRead(pin_Qti_direita);
      if(Qti_direita > 500 && Qti_esquerda > 500){ //LEU 1 LINHA
        do{
          ir_frente();
          delay(250); //Segurança caso um sensor entre primeiro no branco do que outro no caso de linha em paralelo ( robo anda torto )
          Qti_esquerda = analogRead(pin_Qti_esquerda);
          Qti_direita = analogRead(pin_Qti_direita);
        }while(Qti_direita > 500 && Qti_esquerda > 500); //Só para quando um dos QTIs estiver no branco
        if(Qti_direita < 500 && Qti_esquerda < 500){ //Se os dois estiverem no branco -- certeza que é linha para troca de modo
          do{
            ir_frente();
            Qti_esquerda = analogRead(pin_Qti_esquerda);
            Qti_direita = analogRead(pin_Qti_direita);
            ...
            Qti_esquerda = analogRead(pin_Qti_esquerda);
            Qti_direita = analogRead(pin_Qti_direita);
          }while(Qti_direita < 500 || Qti_esquerda < 500); //Só para quando os dois QTIs estiverem no preto AQUI LEU 2 LINHAS
          do{
            ir_frente();
            Qti_esquerda = analogRead(pin_Qti_esquerda);
            Qti_direita = analogRead(pin_Qti_direita);
            ...
            Qti_esquerda = analogRead(pin_Qti_esquerda);
            Qti_direita = analogRead(pin_Qti_direita);
          }while(Qti_direita > 500 || Qti_esquerda > 500); //Só para quando os dois QTIs estiverem no branco
           ...
           do{
            ...
            Qti_esquerda = analogRead(pin_Qti_esquerda);
            Qti_direita = analogRead(pin_Qti_direita);
          }while((Qti_direita < 500 || Qti_esquerda < 500) && times < 50); //Só para quando os dois QTIs estiverem no preto ou o número de vezes for maior que 50 //LEU 3 LINHAS ou FICOU NAS 2 LINHAS
          if(times<50){
            mode = 3;
